  ...
  render: () => {
    ...
    return (
      <Navbar
        logo={logo}
        items={[
          { label: 'Adopt', active: view === 'adopt', onClick: () => setView('adopt') },
          { label: 'Foster', active: view === 'foster', onClick: () => setView('foster') },
          { label: 'Admin', active: view === 'admin', onClick: () => setView('admin'), variant: 'accent' },
        ]}
      />
    );
  },
