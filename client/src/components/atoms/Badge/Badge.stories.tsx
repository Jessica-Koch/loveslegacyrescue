...
const meta = {
  ...
  argTypes: {
    variant: {
      control: 'select',
      options: ['accent', 'secondary', 'muted', 'outline', 'brand'],
    },
...
export const Rotated: Story = {
  ...
  render: () => (
    <div
      style={{ display: 'flex', gap: 24, alignItems: 'center', padding: 32 }}
    >
      <Badge variant='accent' rotate rotateDirection='ccw'>
        Featured
      </Badge>
      <Badge variant='secondary' rotate rotateDirection='cw'>
        In Foster
      </Badge>
      <Badge variant='brand' rotate rotateDirection='ccw'>
        Dog of the Week
      </Badge>
    </div>
  ),
